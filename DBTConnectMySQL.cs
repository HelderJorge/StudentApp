...
//Ligações ao MySQL - maisfuturo - Tabela Teste

public class DBTConnectMySQL
{
    ...
    public string Bind(ref DataGridView gv1, string Disciplina, string Data1, string Data2)
    {
        string Msg;
    ...
    public string Bind(ref DataGridView gv1, string Ano, string Turma, string Escola, string Data1, string Data2)
    {
        string Msg;
        if (Data1.Equals("") || Data2.Equals(""))
        {
    ...
    public bool DevolverTeste(string id,
        ref TextBox Data, ref TextBox Ano, ref TextBox Turma, ref TextBox Escola, ref TextBox Disciplina)
    {
        try
        {
